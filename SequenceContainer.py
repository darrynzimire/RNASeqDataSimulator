...
class SequenceContainer:
	def __init__(self, xOffset, sequence, ploidy, readLen, mutationModels=[], mutRate=None):
		# initialize basic variables
		# self.onlyVCF = onlyVCF
		# self.readLen = readLen
		self.init_basicVars(xOffset, sequence, ploidy, readLen)
	...
	def init_basicVars(self, xOffset, sequence, ploidy, readLen):
		self.x         = xOffset
		self.ploidy    = ploidy
		self.readLen   = readLen
